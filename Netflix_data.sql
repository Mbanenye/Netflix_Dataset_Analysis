-- Data exploration 
-- Mergin all the listed in data to form just two columns
...
-- mergin all the cast in columns into just two
...
-- merging all the countries released columns together.
